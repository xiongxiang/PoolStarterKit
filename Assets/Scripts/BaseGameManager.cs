...
namespace PoolKit {
    public class BaseGameManager {
        ...
        public delegate void OnConnect(bool offlineMode, string sceneName, int nomPlayers, int nomAI);
        public static event OnConnect onConnect;
        public static void connect(bool offlineMode, string sceneName, int nomPlayers, int nomAI) {
            if (onConnect != null) {
                onConnect(offlineMode, sceneName, nomPlayers, nomAI);
            }
        }
